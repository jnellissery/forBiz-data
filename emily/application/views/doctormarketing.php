        ...
        <div class="content_wrapper">        		<h1>Your Information</h1>	
            ...
            <table   width="600" border="0" id="tbl_profile">  
                ...
                <tr>   
                 ...
                 <tr>
                    <td align="left" >Medical Registration Number</td> 
                    <td>       
                ...
                <tr>   
                    <td align="left" >Official Address</td>  
        ...
        <script>           		
            $("#submit").click(function() 	{  
                ...
                $.ajax( {	
                    ...
                    type : "POST",	
                     data : 'name='+name+'&address='+address+'&phone='+phone+'&email='+email+'&state='+state+'&age='+age+'&symptoms='+symptoms+'&type=D',
