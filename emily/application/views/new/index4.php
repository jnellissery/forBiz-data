...
<script type="text/javascript">
		...
		$('#CartModel').html("<div id='maindiv'><table><th colspan='2' ;height='30px' >MALAYALAMANORAMA SURVEY</th><tr height='100%' style='vertical-align:top'><td ><sapn id ='spaninterested'>Interested</span></td> <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<sapn id='spannotinterested'>No Thanks</span></td></tr></table></div>").modal('show');
		$('#spaninterested').bind('mouseover',function(e){ $('#spaninterested').empty();
		$('#spaninterested').after('<table><tr><td style="margin-left:50px"><span>UserName</span></td> <td ><input type="text" name="txt_name1" id="txt_name1" class="rounded required" >  </td></tr><tr><td><span>EmilID</span></td> <td><input type="text" name="txt_email1" id="txt_email1" class="rounded required" > </td></tr><tr><td colspan="2" id="enquiry_status1" align="right"></td></tr><tr><td colspan="2" align="right" style="padding-top:20px;"><a href="#"  class="emily_buttons" onclick= malaya_reg("Int") >Submit Interest</a></td></tr></table>');$('#CartModel').css("height","30%");});
	...
	if (type=='N')
			{
				...
				*/
					...
					url : "http://localhost/emily/emily/emily_enquiry",//"http://www.emily.org.in/emily_enquiry",	
					
					type : "POST",	
					
					data : 'name='+name+'&address='+address+'&phone='+phone+'&email='+email+'&state='+state+'&age='+age+'&symptoms='+symptoms+'&type='+type+'&FR_MALA='+FR_MALA,
...
<!--<div  id="CartModel" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        aria-hidden="true" style="width: 400px; height:auto; left: 50%; top: 30%; text-align: center;background-color:red">
         
    </div>-->
  
  
      <table>
     <td><img width=562 height=163
  src="file:///C:\Users\lenovo\AppData\Local\Temp\msohtmlclip1\01\clip_image002.png"
  alt="Rounded Rectangle: A COMMITMENT TO WOMANHOOD&#13;&#10;DO YOU WANT TO BE FREE FROM HEAVY AND PAINFULL PERIODS&#13;&#10; &#13;&#10;"
  v:shapes="Rounded_x0020_Rectangle_x0020_2"></td><table>

<div id="little_menu" style="display:none">

  <a href="#top" title="Home" class="scroll" title="Home"><img src="images/home.png"></a>

  <a href="#about" title="About Emily" class="scroll" title="About Emily"><img src="images/about_emily.png"></a>

  <a href="#faq" title="FAQ" class="scroll" title="FAQ"><img src="images/home_faq.png"></a>
...
<div id="modal">
	<div id="heading">
		MALAYALAMANORAMA ONLINE SURVEY
	</div>

	<div id="content">
		<p>Are You Satisfied with Emily just Say Yes/No</p>

		<a href="#" id="int" class="button green close"  onclick= malaya_reg("I") ><img src="images/tick.png">Interested!</a>

		<a href="#" id ="nint" class="button red close" onclick= malaya_reg("N")><img src="images/cross.png">Not Interested!</a>
	</div>
</div>
		<div id="scrolldown">
