      ...
      <div id="inner_content">
        ...
        <div class="contact-addresspart">
                	...
                	<div class="contact-address"><p>Corporate R &amp; D Centre<br>HLL Lifecare Limited<br>Akkulam<br>Trivandrum<br>Kerala -695017</p></div>
                 	...
                 	<div class="contact-phone"><p><br>Phone : 04712774700<br>Email: <a href="mailto:emily@lifecarehll.com">emily@lifecarehll.com</a></p></div>
...
<?php  
//
//echo $this->session->userdate('some_name');
//$this->output->cache(n);
	//$this->output->enable_profiler(TRUE);
	echo( "this is for testing session");
?>
