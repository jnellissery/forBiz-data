...
<div class="wrapper">	<header class="pageheader">  	
        <div class="logo"><a href="<?php echo base_url(); ?>home">
                <img src="<?php echo base_url(); ?>images/logo.png" width="142" height="65" alt="Emily"></a>
        ...
        <nav>            	<div class="nav-left"></div>             
            <div class="navigation">  
                ...
                if ($usertype == 'patient' || $page == 'patient_profile' || $page == 'instruction' || $page == 'askadoctor') {
                    ?>
                    <ul>                    	
                        <li  <?php echo $page == 'patient_profile' ? 'class="active"' : ''; ?> style="padding:0 7px"><a href="<?php echo base_url(); ?>patient_profile">View Profile</a></li>    
                        <li <?php echo $page == 'enter_score' ? 'class="active"' : ''; ?> style="padding:0 7px"><a href="<?php echo base_url(); ?>enter_score">Enter Data</a></li>                      
                        <li <?php echo $page == 'askadoctor' ? 'class="active"' : ''; ?> style="padding:0 7px"><a href="<?php echo base_url(); ?>askadoctor">Contact My Doctor</a></li>   
...
<?php } else if ($page == 'profile' || $page == 'askadoctor' || $usertype == 'doctor' || $page == 'patientlist' || $page == 'deletepatient') { ?>            
                    <ul>     
                        <li <?php echo $page == 'patientlist' ? 'class="active"' : ''; ?> style="padding:0 7px"><a href="<?php echo base_url(); ?>patientlist/1">Subject List</a></li>
                        <li <?php echo $page == 'profile' ? 'class="active"' : ''; ?> style="padding:0 7px"><a href="<?php echo base_url(); ?>profile">New Subject</a></li>           
					...
					<?php }
					else if($page == 'patient_profile1')
					{
					?>
					<ul>                    	
                        <li  <?php echo $page == 'patient_profile1' ? 'class="active"' : ''; ?> style="padding:0 7px"><a href="<?php echo base_url(); ?>patient_profile">View Profile</a></li>    
                        <li <?php echo $page == 'enter_score' ? 'class="active"' : ''; ?> style="padding:0 7px"><a href="<?php echo base_url(); ?>enter_score">Enter Data</a></li>                      
                   </ul>    
						<?php } else { ?> 
                    <ul>                    	
  ...
  <li <?php $class = ($page == 'aaa' ? 'class="active"' : '');
    ...
    function get_months($date1, $date2) {
        ...
        $str = "You are with Emily/LNG-IUS for ";
        if ($interval->y != 0) {
