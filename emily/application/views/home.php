...
<section class="gall" >      
    <!--round boxes -->      <div class="content_wrapper">
	
	 <div id="slider-wrapper">
            <div id="slider" class="nivoSlider">
                <a href="#"><img src="slider/images/img1.jpg"/></a>
                <a href="#"><img src="slider/images/img2.jpg"/></a>
                <a href="#"><img src="slider/images/img3.jpg"/></a>
                <a href="#"><img src="slider/images/img4.jpg"/></a>
            </div>
        ...
        <!-- Round Box Content       	<div  class="slider" style="position:relative" >     
            ...
            <div class="what_emily">            	
                ...
                <ul>    
                    ...
                    <li>It provides effective contraception for a long period of time and also is indicated for the management of heavy menstrual blood loss.</li>                    <li>You can become pregnant after the removal of Emily.</li> 
                </ul>              
                <div class="know_btn">
    ...
    <script type="text/javascript" src="slider/js/jquery-1.6.1.min.js"></script>
...
<article id="mainArticle">    		
    ...
    <ul class="columns">    
	 ...
	 <li class="intrest_emily">
                ...
                <a href="#"> <a href=" <?php echo base_url(); ?>doctormarketing"><img src="images/iamadoctor.png"></a>

                <a href="#"> <a href=" <?php echo base_url(); ?>marketing"><img src="images/iamapatient.png"></a>
        ...
        <!--<li class="intrest_emily">     
            ...
            <div class="click-btn">
                ...
                <a href="<?php /*?><?php echo base_url();?><?php */?>marketing"><img src="images/click-btn.png" width="111" height="71"></a>

            </div>            </li>   -->     	<!-- Interested in Emily -->       
...
?> 
            ...
            <label class="invalid_login_label">Invalid Login</label>    

			<label class="invalid_login_label">

				<a href="#">Forgot Password?</a>

			</label> 

			<div class="forms pad20alltop10">    
        ...
        <li class="physician_login" id="physician_login">           
            ...
            <h3>Physician Login</h3>     <?php if (isset($_GET['login'])){
...
<script type="text/javascript" src="<?php /*?><?php echo base_url(); ?><?php */?>/js/jquery.nivo.slider.js"></script>  
<script type="text/javascript">    
