...
/* -- Smooth scroll -- */
	...
	var scrollDuring=900; /* Duree du Scroll 1000 = 1seconde */
...
{
$('#trage').hide();
	document.getElementById('show_required_field_label').innerHTML="Medical Registration Number ";
}
	else
	{
$('#trage').show();
	document.getElementById('show_required_field_label').innerHTML="Symptoms";
	}
